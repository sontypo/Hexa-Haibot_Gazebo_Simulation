...
"""autogenerated by genpy from h_robix_control/SetGroupMotorData.msg. Do not edit."""
import codecs
import sys
...
class SetGroupMotorData(genpy.Message):
  _md5sum = "d24f6d6ff0914be0afb7864c32f01a60"
  _type = "h_robix_control/SetGroupMotorData"
...
int32 motor6_data
"""
  __slots__ = ['motor1_id','motor2_id','motor3_id','motor4_id','motor5_id','motor6_id','data_required','motor1_data','motor2_data','motor3_data','motor4_data','motor5_data','motor6_data']
  _slot_types = ['uint8','uint8','uint8','uint8','uint8','uint8','string','int32','int32','int32','int32','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       motor1_id,motor2_id,motor3_id,motor4_id,motor5_id,motor6_id,data_required,motor1_data,motor2_data,motor3_data,motor4_data,motor5_data,motor6_data
    ...
    """
    if args or kwds:
      super(SetGroupMotorData, self).__init__(*args, **kwds)
