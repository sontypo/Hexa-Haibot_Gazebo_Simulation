...
if("TRUE" STREQUAL "TRUE")
  set(ekf_SOURCE_PREFIX /home/saun/6legged_robot/src/ekf)
  set(ekf_DEVEL_PREFIX /home/saun/6legged_robot/devel)
  set(ekf_INSTALL_PREFIX "")
  set(ekf_PREFIX ${ekf_DEVEL_PREFIX})
else()
  set(ekf_SOURCE_PREFIX "")
  set(ekf_DEVEL_PREFIX "")
  set(ekf_INSTALL_PREFIX /home/saun/6legged_robot/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ekf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saun/6legged_robot/src/ekf/${idir}'.  ${_report}")
    endif()
