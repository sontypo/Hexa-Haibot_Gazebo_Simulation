...
class Respawn():
    def __init__(self):
        ...
        self.modelPath = self.modelPath.replace('deep_rl_hexapod/src',
                                                'robot_gazebo/models/turtlebot3_square/goal_box/model.sdf')
        ...
        # self.init_goal_x = 1.25  #| fixed goal less obstacles
        # self.init_goal_y = 1.25  #|
        self.init_goal_x = 1.5  #| fixed goal hexapod_yard.world
