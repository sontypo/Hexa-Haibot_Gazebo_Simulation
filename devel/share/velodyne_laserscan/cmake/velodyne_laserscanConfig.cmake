...
if("TRUE" STREQUAL "TRUE")
  set(velodyne_laserscan_SOURCE_PREFIX /home/saun/6legged_robot/src/velodyne/velodyne_laserscan)
  set(velodyne_laserscan_DEVEL_PREFIX /home/saun/6legged_robot/devel)
  ...
  set(velodyne_laserscan_INSTALL_PREFIX /home/saun/6legged_robot/install)
...
if(NOT "/home/saun/6legged_robot/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velodyne_laserscan' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saun/6legged_robot/src/velodyne/velodyne_laserscan/${idir}'.  ${_report}")
    endif()
