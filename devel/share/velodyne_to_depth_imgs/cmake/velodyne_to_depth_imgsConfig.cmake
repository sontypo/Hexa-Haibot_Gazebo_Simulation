...
if(velodyne_to_depth_imgs_CONFIG_INCLUDED)
  return()
endif()
set(velodyne_to_depth_imgs_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(velodyne_to_depth_imgs_SOURCE_PREFIX /home/saun/6legged_robot/src/velodyne_to_depth_imgs)
  set(velodyne_to_depth_imgs_DEVEL_PREFIX /home/saun/6legged_robot/devel)
  set(velodyne_to_depth_imgs_INSTALL_PREFIX "")
  set(velodyne_to_depth_imgs_PREFIX ${velodyne_to_depth_imgs_DEVEL_PREFIX})
else()
  set(velodyne_to_depth_imgs_SOURCE_PREFIX "")
  set(velodyne_to_depth_imgs_DEVEL_PREFIX "")
  set(velodyne_to_depth_imgs_INSTALL_PREFIX /home/saun/6legged_robot/install)
  set(velodyne_to_depth_imgs_PREFIX ${velodyne_to_depth_imgs_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'velodyne_to_depth_imgs' is deprecated")
...
set(velodyne_to_depth_imgs_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu;/usr/include/ni;/usr/include/openni2 " STREQUAL " ")
  set(velodyne_to_depth_imgs_INCLUDE_DIRS "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${velodyne_to_depth_imgs_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'velodyne_to_depth_imgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'velodyne_to_depth_imgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/saun/6legged_robot/src/velodyne_to_depth_imgs/${idir}'.  ${_report}")
    endif()
    _list_append_unique(velodyne_to_depth_imgs_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND velodyne_to_depth_imgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND velodyne_to_depth_imgs_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT velodyne_to_depth_imgs_NUM_DUMMY_TARGETS)
      set(velodyne_to_depth_imgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::velodyne_to_depth_imgs::wrapped-linker-option${velodyne_to_depth_imgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR velodyne_to_depth_imgs_NUM_DUMMY_TARGETS "${velodyne_to_depth_imgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::velodyne_to_depth_imgs::wrapped-linker-option${velodyne_to_depth_imgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND velodyne_to_depth_imgs_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(velodyne_to_depth_imgs_LIBRARY_DIRS ${lib_path})
      list(APPEND velodyne_to_depth_imgs_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'velodyne_to_depth_imgs'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND velodyne_to_depth_imgs_LIBRARIES ${lib})
    endif()
  endif()
...
set(velodyne_to_depth_imgs_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${velodyne_to_depth_imgs_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 velodyne_to_depth_imgs_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${velodyne_to_depth_imgs_dep}_FOUND)
      find_package(${velodyne_to_depth_imgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${velodyne_to_depth_imgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(velodyne_to_depth_imgs_INCLUDE_DIRS ${${velodyne_to_depth_imgs_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(velodyne_to_depth_imgs_LIBRARIES ${velodyne_to_depth_imgs_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${velodyne_to_depth_imgs_dep}_LIBRARIES})
  _list_append_deduplicate(velodyne_to_depth_imgs_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(velodyne_to_depth_imgs_LIBRARIES ${velodyne_to_depth_imgs_LIBRARIES})

  _list_append_unique(velodyne_to_depth_imgs_LIBRARY_DIRS ${${velodyne_to_depth_imgs_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(velodyne_to_depth_imgs_EXPORTED_TARGETS ${${velodyne_to_depth_imgs_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${velodyne_to_depth_imgs_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
