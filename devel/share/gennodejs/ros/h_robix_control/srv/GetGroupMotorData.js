...
// (in-package h_robix_control.srv)
...
class GetGroupMotorDataRequest {
  constructor(initObj={}) {
    if (initObj === null) {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetGroupMotorDataRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetGroupMotorDataRequest
    let len;
    let data = new GetGroupMotorDataRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetGroupMotorDataRequest(null);
...
class GetGroupMotorDataResponse {
  constructor(initObj={}) {
    if (initObj === null) {
      // initObj === null is a special case for deserialization where we don't initialize fields
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type GetGroupMotorDataResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type GetGroupMotorDataResponse
    let len;
    let data = new GetGroupMotorDataResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GetGroupMotorDataResponse(null);
...
module.exports = {
  Request: GetGroupMotorDataRequest,
  Response: GetGroupMotorDataResponse,
  md5sum() { return '1d809d6a5bd5cdb4eacfae0651cc8f04'; },
  datatype() { return 'h_robix_control/GetGroupMotorData'; }
};
